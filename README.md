...
1. Add the repository into your Hugo Project repository as a submodule, `git submodule add -b serhat https://github.com/SerhatTeker/hugo-coder.git themes/hugo-coder`.
